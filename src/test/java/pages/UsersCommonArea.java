...
public class UsersCommonArea {
    ...
    public WebElement mngDashboardsOptions(String option){
    ...
    public WebElement mngFleetOptions(String option){
    ...
    public WebElement mngCustomersOptions(String option){
        // Accounts, Contacts
    ...
    public WebElement mngMarketingOptions(String option){
        //
    ...
    public WebElement mngReportsOptions(String option){
    ...
    public WebElement mngSystemOptions(String option){
