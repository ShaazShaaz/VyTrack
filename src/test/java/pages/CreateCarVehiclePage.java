...
public class CreateCarVehiclePage {

    public CreateCarVehiclePage() {
    ...
    @FindBy(xpath = "//div[contains(@id, 'custom_entity_type_Vehicle_Model')]//button[contains(@class, 'btn-medium add-btn')]")
    public WebElement addVehicleModelBtn;

    //public WebElement vehicleModelCheckbox(String name) {
    // return getDriver().findElement(By.xpath("//tbody[@class='grid-body']//td[@data-column-label='Model Name'][text()='" + name + "']/..//input"));
    //}

    public WebElement vehicleModelCheckbox(int rowNumb) {
        return getDriver().findElement(By.xpath("//tr[@class='grid-row'][" + rowNumb + "]//input"));
    }
    ...
    @FindBy(xpath = "//div[contains(@id, 'custom_entity_type_Vehicle_Make')]//button[contains(@class, 'btn-medium add-btn')]")
    public WebElement addVehicleMakeBtn;

    //    public WebElement vehicleMakeCheckbox(String name) {
//        return getDriver().findElement(By.xpath("//tbody[@class='grid-body']//td[@data-column-label='Make'][text()='"+name+"']/..//input"));
//    }
    public WebElement vehicleMakeCheckbox(int rowNumb) {
        return getDriver().findElement(By.xpath("//tr[@class='grid-row'][" + rowNumb + "]//input"));
    }
    ...
    @FindBy(xpath = "//div[@class='message'][text()='Entity saved']")
    ...
    public void fillOutForm() {
        ...
        waitFor(3);
        String licencePlate = faker.numerify("#########");
        ...
        form.chassisNumbBox.sendKeys(faker.numerify("############"));
        ...
        form.horsepowerBox.sendKeys(faker.number().numberBetween(100, 300) + "");
        form.horsepowerTaxationBox.sendKeys(faker.number().numberBetween(1, 20) + "");
        form.powerBox.sendKeys(faker.numerify("###"));
        //**
        form.uploadFile.sendKeys("/Users/YuliiaNazarova/Desktop/logo.jpeg");
        //**

        form.addVehicleModelBtn.click();
        waitFor(2);
        //form.vehicleModelCheckbox("corolla");
        form.vehicleModelCheckbox(4).click();
        form.selectVehicleModelBtn.click();
        //**
        form.addVehicleMakeBtn.click();
        form.vehicleMakeCheckbox(7).click();
        form.selectVehicleMakelBtn.click();
    }
}
